...
class ImageMap_Area_Polygon extends ImageMap_Area
{
	var $points = array();
...
class ImageMap_Area_Rectangle extends ImageMap_Area
{
	var $x1,$x2,$y1,$y2;
...
class ImageMap_Area_Circle extends ImageMap_Area
{
...
class ImageMap
{
	...
	{
		if (is_object($element) && is_subclass_of($element, ImageMap_Area::class)) {
			$elementObject = &$element;
		} else {
			$args = func_get_args();
			$className = 'Weathermap\\Html\\ImageMap_Area_' . $element;
